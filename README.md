...
* **Upping Your Defenses and Detections For the Low Low Price of FREEEEE | Kent & Jordan | 1 Hour** - Thu, Dec 17, 2020 2:00 PM - 3:00 PM EST - The boys are back! This webcast will serve as a review of their 2020 research including tools, defenses, detections, and lessons learned. As always, and in keeping in the spirit of limited budgets, the majority of tools discussed will be free or open-source (with an appropriate shout out to byt3bl33d3r’s recent call to arms). The research shared in this webcast can serve companies (and families) of any size and help produce better outcomes through simple recommendations to improve detections and step up your defenses.https://register.gotowebinar.com/register/321308495447920397
...
* **Releasing Your First (Python) Open Source Project to the Masses! | Ian Lee | 2 Hours** - Wed, Jan 13, 2021 1:00 PM - 3:00 PM EST - This Hackin Cast will build somewhat on the "Intro to Git" workshop I presented at WWHF Deadwood 2020 and continue the journey of actually getting your idea for a cool new project out in front of the world. You will benefit from either having seen that workshop or having done any of the many Git tutorials available online (e.g., https://try.github.io/). We'll pick up from having just learned how to start using Git and work through how to take that knowledge to start your own first open source project. https://register.gotowebinar.com/register/1191419115832302349
